...
static const char *help="usage: ortp_send_g711 filename dest_ip4addr dest_port [ --with-clockslide <value> ] [ --with-jitter <milliseconds>]\n";
...
int main(int argc, char *argv[])
{
    ...
    rtp_session_set_connected_mode(session,FALSE);   // no connect  
    rtp_session_set_remote_addr(session,argv[2],atoi(argv[3]));
    rtp_session_set_payload_type(session,8);         // test.g711 is PCMA, payload type is 8
